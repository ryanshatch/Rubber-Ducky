...
<code>Install and have your USB Rubber Ducky working in less than 2 minutes.</code>

1. Clone the repo to get a local copy of the files. `git clone https://github.com/ryanshatch/Rubber-Ducky.git`

2. Download [CircuitPython for the Raspberry Pi Pico](https://circuitpython.org/board/raspberry_pi_pico/). *Updated to 8.2.0  
   Download [CircuitPython for the Raspberry Pi Pico W](https://circuitpython.org/board/raspberry_pi_pico_w/). *Updated to 8.2.0

3. Plug the device into a USB port while holding the `BOOT SEL` button. It will show up as a removable media device named `RPI-RP2`.

4. Copy the downloaded `.uf2` file to the root of the Pico (`RPI-RP2`). The device will reboot and after a second or so, it will reconnect as `CIRCUITPY`.

5. Drag and drop all contents from this repo to your Raspberry Pi Pico

6. The Script will be within the file named, "`payload.dd`." Find the payload and replace it with your own payload.
...
7. Find a script [here](https://github.com/hak5/usbrubberducky-payloads) or [create your own one using Ducky Script](https://docs.hak5.org/hak5-usb-rubber-ducky/ducky-script-basics/hello-world) and save it as `payload.dd` in the Pico. Currently, pico-ducky only supports DuckyScript 1.0, not 3.0.
